<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <jsp:include page="WEB-INF/head.jsp">
    	<jsp:param  name="title" value="Proveedor"/>
    </jsp:include>
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="input-group col-lg-9">
                            <input type="text" class="form-control" placeholder="Buscar por nombre" onkeyup="" id="txtfiltraremp">
                            <span class="input-group-btn">
                                <button class="btn btn-secondary" >Buscar</button>
                            </span>
                        </div>
                    <input type="button" name="" value="Nuevo" class="btn btn-primary" data-toggle="modal" data-target="#fm-modal-add-sup" style="margin-left: 20px;">
                  </div>                
                                    
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter text-nowrap" id="tblproveedores">
                      <thead>
                        <tr>
                          <th class="w-1">Cod. Proveedor</th>
                          <th>Nombre</th>
                          <th>Dirección</th>                   
                          <th>Email</th>
                          <th>Teléfono</th>
                    ...
                    <jsp:include page="editarProveedor.jsp"></jsp:include>
                    <jsp:include page="eliminarProveedor.jsp"></jsp:include>
