                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">                     
                            ...
                            <input type="text" class="form-control" placeholder="Ap. Paterno" name="txtaddappaterno" id="id-add-segnombre">
                           
 
                            <label class="form-control-label"   for="">Ap. Materno:</label>                        
                            <input type="text" class="form-control" placeholder="Ap. Materno" name="txtaddapmaterno"    id="id-add-apellido">
